...
//Brief Introduction to Use of program 
...
//Displaying data of directory in ls format
//it includes modification time, size, user id, group, path, etc
...
//Main function of this is to gather the information of directory and process it
...
//It is used to free the linked list of options
